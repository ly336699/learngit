...
>  > >暂存区的状态就变成这样了
>  > >![图解]（https://cdn.liaoxuefeng.com/cdn/files/attachments/001384907720458e56751df1c474485b697575073c40ae9000/0）
>  > >然后，执行git commit就可以一次性把暂存区的所有修改提交到分支
>  > >版本库变成了这样
>  > >![图解]（https://cdn.liaoxuefeng.com/cdn/files/attachments/0013849077337835a877df2d26742b88dd7f56a6ace3ecf000/0）
>  ---------
> **管理修改**
>  >**Git跟踪并管理的是修改，而非文件**
...
>  >修复完成后，切换到bug所处分支，并完成合并，最后删除issue-101分支
>  > >`$ git checkout bug`
...
>  > >*注:f52c633是某一历史时期提交的commit的id，v0.9是标签* 
